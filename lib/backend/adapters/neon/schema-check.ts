/**
 * Los tipos generados de Neon encajan con `rows.ts`, o esto no compila.
 *
...
import type { Tables, Views } from "@/lib/backend/adapters/neon/database.types";

export const NEON_SCHEMA_MATCHES_ROWS: [
