...
function DesktopHero() {
  return (
    <div className="hidden max-w-130 flex-col gap-6 lg:flex">
      ...
      <p className="max-w-130 text-[15px] leading-relaxed text-pretty text-muted-foreground">
        {AUTH_COPY.heroLead}
      </p>
    </div>
  );
  ...
  return (
    <div className={PAGE_CLASS}>
      ...
      <main className="flex flex-1 flex-col justify-center px-6 py-6 lg:px-16">
        ...
        <div className="mx-auto flex w-full flex-col gap-10 lg:max-w-5xl lg:flex-row lg:items-center lg:justify-between lg:gap-16">
          <DesktopHero />
