...
const CTA_CLASS =
  "flex h-13 items-center justify-center rounded-full text-[15px] font-bold uppercase tracking-[0.08em] transition-colors lg:h-14 lg:px-10";

const CTA_PRIMARY_CLASS = `${CTA_CLASS} bg-primary text-primary-foreground hover:opacity-90`;

const CTA_SECONDARY_CLASS = `${CTA_CLASS} border border-border hover:border-primary hover:text-primary`;
